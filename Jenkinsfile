...
echo Git push origin master'''
        ...
        stage('error') {
          steps {
            ...
            SWEAGLEExport(actionName: 'GetConfig', mdsName: 'Client-PRD', fileLocation: 'https://github.com/BRSweagle/JenkinsDeploy/blob/master/Client-PRD.yaml', exporter: 'all', format: 'yaml')
          }
        }
      }
    }
